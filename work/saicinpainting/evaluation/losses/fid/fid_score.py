...
Code apapted from https://github.com/bioinf-jku/TTUR to use Pypaddle instead
of Tensorflow
...
from paddlevision.transforms import CenterCrop, Compose, Resize, ToTensor
...
def get_activations(files, model, batch_size=50, dims=2048,
    ...
    for i in tqdm(range(n_batches)):
        ...
        # images /= 255
        # batch = paddle.from_numpy(images).type(paddle.FloatTensor)
        # #
