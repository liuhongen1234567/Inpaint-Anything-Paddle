...
def feature_matching_loss(fake_features: List[paddle.Tensor], target_features: List[paddle.Tensor], mask=None):
    if mask is None:
        res = paddle.stack([F.mse_loss(fake_feat, target_feat)
