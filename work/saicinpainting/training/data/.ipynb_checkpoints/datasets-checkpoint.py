...
# from paddle.utils.data import Dataset, IterableDataset, DataLoader, DistributedSampler, ConcatDataset
...
# class InpaintingTrainDataset(paddle.io.Dataset):
...
#         tensor = paddle.from_numpy(np.clip(mask.astype(int)-1, 0, None))
